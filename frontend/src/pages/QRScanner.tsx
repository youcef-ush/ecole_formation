...
export default function QRScanner() {
  ...
  const handleScan = async (decodedText: string) => {
    ...
    try {
      ...
      console.log("[QRScanner] Calling API with:", {
        qrCode: cleanCode,
            ...
            <CardContent>
              <Box sx={{ mb: 3 }}>
                <FormControl fullWidth>
                  <InputLabel>
                    Sélectionner une formation (Optionnel)
                  </InputLabel>
                  <Select
              ...
              <Box sx={{ display: "flex", justifyContent: "center", mb: 2 }}>
                ...
                >
                  {isCameraMode
                    ? "Utiliser le Scanner USB / Clavier"
                    : "Utiliser la Caméra"}
                </Button>
              </Box>
              ...
              {error && (
                <Fade in>
                  <Paper
                    sx={{ mt: 2, p: 2, bgcolor: "#ffebee", color: "#c62828" }}
                  >
              ...
              <TableBody>
                {(() => {
                  const filteredHistory = history.filter((log) => {
                    ...
                    const matchesCourse =
                      historyCourse === "all" ||
                      log.courseId.toString() === historyCourse;

                    const matchesDate =
                      !historyDate ||
                      new Date(log.accessTime).toISOString().split("T")[0] ===
                        historyDate;
